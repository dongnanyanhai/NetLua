...
namespace NetLuaDesigner
{
    public class MainForm : Form
    {
        ...
        private void OpenDesignedForm()
        {
            ...
            openFileName.Filter = "NLua Form format (*.nlua)|*.nlua";

            openFileName.FilterIndex = 1;
            openFileName.RestoreDirectory = false;
            ...
            if (openFileName.ShowDialog() == DialogResult.OK)
            {
                ...
                if (this.dockPanel.ActiveDocument is DesignerDocument doc)
                {
                    doc.curFileName = openFileName.FileName;
                }
                ...
                txtReader.Close();
                // 读取开头部分
                var prevIndex = layoutString.IndexOf("function _M:InitializeComponent()");
                if(prevIndex > -1){
                    this.luaPrevCode = layoutString.Substring(0,prevIndex);
                }
                // 读取XML部分
                var xmlStartIndex = layoutString.IndexOf("--[[<Object");
                var xmlEndIndex = layoutString.IndexOf("Object>--]]");
                if(xmlStartIndex > -1 && xmlEndIndex > -1){
                    // 必须去掉开头的--[[和结尾的--]]
                    xmlStartIndex = xmlStartIndex + "--[[".Length;
                    xmlEndIndex = xmlEndIndex - xmlStartIndex + "Object>".Length;
                    layoutString = layoutString.Substring(xmlStartIndex, xmlEndIndex);
                }
        ...
        private void SaveDesignedCode(string fileName)
        {
            string xmlCode = this.activeDesigner.LayoutXML;
            string luaCode = this.converter.ToLua(xmlCode,this.luaPrevCode);
            luaCode = luaCode.Replace("--[[XML--]]","--[["+xmlCode+"--]]");
            TextWriter txtWriter = new StreamWriter(fileName);
            txtWriter.Write(luaCode);
            txtWriter.Close();
            if( this.miSelectXML.Checked == true ){
                TextWriter txtWriter2 = new StreamWriter(fileName.Replace(".nlua",".xml"));
                txtWriter2.Write(xmlCode);
                txtWriter2.Close();
            }
        }
        ...
        private void SaveDesignedForm()
        {
            if (this.dockPanel.ActiveDocument is DesignerDocument doc)
            {
                if(doc.curFileName != null && doc.curFileName != ""){
                    this.SaveDesignedCode(doc.curFileName);
                }else{
                    var saveFileName = new SaveFileDialog();
                    saveFileName.Filter = "NLua Form (*.nlua)|*.nlua";

                    saveFileName.FilterIndex = 1;
                    saveFileName.RestoreDirectory = false;

                    if (saveFileName.ShowDialog() == DialogResult.OK)
                    {
                        doc.curFileName = saveFileName.FileName;
                        this.SaveDesignedCode(saveFileName.FileName);
                    }
                }
            }
        }
        ...
        {
            MessageBox.Show("NetLua WinForms Designer" + Environment.NewLine +
                "Copyright © 2022 HiCode",
                "关于",
                MessageBoxButtons.OK);
        }
        #endregion

        private void miSelectXML_Click(object sender, EventArgs e)
        {
            if (this.miSelectXML.Checked == true)
            {
                this.miSelectXML.Checked = false;
            }
            else
            {
                this.miSelectXML.Checked = true;
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.miSelectXML = new System.Windows.Forms.MenuItem();
            ...
            // miSelectXML
            // 
            this.miSelectXML.Index = 4;
            this.miSelectXML.Text = "XML";
            this.miSelectXML.Click += new System.EventHandler(this.miSelectXML_Click);
            // 
            // menuItem7
            // 
            ...
            this.tbNewForm.Image = global::NetLuaDesigner.Properties.Resources.new_from_16x;
            ...
            this.tbOpenForm.Image = global::NetLuaDesigner.Properties.Resources.open_file_16x;
            ...
            this.tbSaveForm.Enabled = false;
            this.tbSaveForm.Image = global::NetLuaDesigner.Properties.Resources.save_16x;
            ...
            this.tbPreview.Enabled = false;
            this.tbPreview.Image = global::NetLuaDesigner.Properties.Resources.preview_16x;
            ...
            this.tbUndo.Image = global::NetLuaDesigner.Properties.Resources.undo_16x;
            ...
            this.tbRedo.Image = global::NetLuaDesigner.Properties.Resources.redo_16x;
            ...
            this.tbDelete.Enabled = false;
            this.tbDelete.Image = global::NetLuaDesigner.Properties.Resources.delete_16x;
            ...
            this.tbAlignLeft.Image = global::NetLuaDesigner.Properties.Resources.align_left_16x;
            ...
            this.tbAlignCenter.Image = global::NetLuaDesigner.Properties.Resources.align_center_16x;
            ...
            this.tbAlignRight.Image = global::NetLuaDesigner.Properties.Resources.align_right_16x;
            ...
            this.tbAlignTop.Image = global::NetLuaDesigner.Properties.Resources.align_top_16x;
            ...
            this.tbAlignMiddle.Image = global::NetLuaDesigner.Properties.Resources.align_middlle_16x;
            ...
            this.tbAlignBottom.Image = global::NetLuaDesigner.Properties.Resources.align_bottom_16x;
            ...
            this.tbSameWidth.Image = global::NetLuaDesigner.Properties.Resources.same_width_16x;
            ...
            this.tbSameHeight.Image = global::NetLuaDesigner.Properties.Resources.same_height_16x;
            ...
            this.tbSameBoth.Image = global::NetLuaDesigner.Properties.Resources.same_size_16x;
        ...
        internal Convert Converter { get => converter; set => converter = value; }
